...
})({"e2e3W":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 1839;
...
const controlAddRecipeData = async function(newReipe) {
    try {
        ...
        await _modelJs.uploadRecipe(newReipe);
...
const init = function() {
    ...
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipeData);
};
init();
...
const uploadRecipe = async function(newReipe) {
    try {
        const ingredients = Object.entries(newReipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ing)=>{
            const ingArr = ing[1].split(',').map((el)=>el.trim());
            if (ingArr.length !== 3) throw new Error('Wron Ingrident Format ! please  use the correct format ');
...
},{"regenerator-runtime":"f6ot0","./config.js":"2hPh4","./helper.js":"b1fwP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
const KEY = '1462d632-4efc-4a17-966a-e600b9dca15f';
...
},{"./View":"jSw21","url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jSw21":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    _data;
    /**
   *Render the recived object to thr DOM 

   * @param {object | Object []} data the data to render (e.g recipre)
...
},{"./View":"jSw21","./previewView":"6tKHS","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkUp() {
        ...
        if (currentPage === 1 && numsPages > 1) return `
      ...
      `;
        // Last Page
        if (currentPage === numsPages && numsPages > 1) return `
      <button data-goto = "${currentPage - 1}" class="btn--inline pagination__btn--prev">
        ...
        // Other Page
        if (currentPage < numsPages) return `
      <button data-goto = "${currentPage - 1}" class="btn--inline pagination__btn--prev">
          <svg class="search__icon">
            <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
          </svg>
...
},{"./View":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["e2e3W","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")
